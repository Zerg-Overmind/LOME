...
class VaceWanModel(torch.nn.Module):
    def __init__(
        ...
        # adding control adapter
        # self.control_adapter = SimpleAdapter(in_dim_control_adapter=24, dim=1536, kernel_size=[2,2], stride=[2,2])
        
        self.control_adapter = SimpleAdapter(24, 5120, [2,2], [2,2])
        self.ref_conv = torch.nn.Conv2d(16, dim, kernel_size=(2, 2), stride=(2, 2))
